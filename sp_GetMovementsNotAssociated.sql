...
-- Description: Get the movements filtered by some params AND their status is "Activo" (1) or "En proceso" (2)
-- STORED PROCEDURE NAME:	sp_GetMovementsNotAssociated
-- ===============================================================================================================================
-- PARAMETERS:
...
-- ===============================================================================================================================
CREATE PROCEDURE sp_GetMovementsNotAssociated(
    @account INT,
    @pageRequested INT,
    @beginDate DATE,
    @endDate DATE

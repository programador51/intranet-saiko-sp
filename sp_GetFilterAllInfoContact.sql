...
-- Description: gets all contacts for a customer
-- STORED PROCEDURE NAME:	sp_GetFilterAllInfoContact
-- STORED PROCEDURE OLD NAME: sp_filterAllInfoContact
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
...
GO
CREATE PROCEDURE sp_filterAllInfoContact
(
    ...
    SELECT customerID,
            contactID,firstName,middleName,lastName1,lastName2,
                ...
                END AS statusText,
                    ...
                    FROM Contacts WHERE customerID=@customerID AND (

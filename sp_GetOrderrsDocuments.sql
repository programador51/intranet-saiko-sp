...
-- Description: Get the orders documents
-- STORED PROCEDURE NAME:	sp_GetOrdersDocuments
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
...
-- Create Date: 0/26/2022
-- Description: sp_GetOrdersDocuments - Get the orders documents
CREATE PROCEDURE sp_GetOrdersDocuments(
    @customerId INT,
    @statusId INT,
    @beginDate DATETIME,
    @endDate DATETIME,

...
-- Description: Gets all the invoce emitted by filters like document number, status, excecutive and by a range of dates
-- STORED PROCEDURE NAME:	sp_GetInvoiceEmitted
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
...
-- VARIABLES:
-- ===================================================================================================================================
-- Returns: All the invoce emitted by filters like document number, status, excecutive and by a range of dates
-- =============================================
-- **************************************************************************************************************************************************
...
-- Create Date: 02/10/2022
-- Description: sp_GetInvoiceEmitted -Gets all the invoce emitted by filters like document number, status, excecutive and by a range of dates
-- =============================================
CREATE PROCEDURE sp_GetInvoiceEmitted
    (
        @executiveId INT,
        @documentNumber INT,
        @statusId INT,
...
BEGIN
    ...
    DECLARE @WHERE_PAGINATION NVARCHAR (MAX);-- CONDICION 'WHERE' SE REPITE PARA TODOS LOS ESCENARIOS DEL FILTRO EN LA PAGINACION

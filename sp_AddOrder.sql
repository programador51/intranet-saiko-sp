...
-- Description: Adds the order document
-- STORED PROCEDURE NAME:	sp_AddOrder
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
...
DROP PROCEDURE dbo.sp_AddOrder -- !Eliminar cuando sea necesaario
...
-- Create Date: 12/28/2022
-- Description: sp_AddOrder - Adds the order document
...
BEGIN
    ...
    DECLARE @documentStatus INT =9-- No facturado
    DECLARE @documentType INT =2 --Pedido

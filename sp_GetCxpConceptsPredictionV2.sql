...
-- Description: 
-- STORED PROCEDURE NAME:	sp_GetCxpConceptsPredictionV2
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
...
-- =================================================================================================
--	2024-01-25		Adrian Alardin   			1.0.0.0			Initial Revision	
-- *****************************************************************************************************************************
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name ='sp_GetCxpConceptsPredictionV2')
    BEGIN 

        DROP PROCEDURE sp_GetCxpConceptsPredictionV2;
    END
GO
SET ANSI_NULLS ON
GO
...
-- Create Date: 01/25/2024
-- Description: sp_GetCxpConceptsPredictionV2 - Versiond 2 del cxpPrediction 
CREATE PROCEDURE sp_GetCxpConceptsPredictionV2(

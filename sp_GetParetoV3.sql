...
-- Description: 
-- STORED PROCEDURE NAME:	sp_GetParetoV3
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
...
-- =================================================================================================
--	2024-03-13		Adrian Alardin   			1.0.0.0			Initial Revision	
-- *****************************************************************************************************************************
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name ='sp_GetParetoV3')
    BEGIN 

        DROP PROCEDURE sp_GetParetoV3;
    END
GO
SET ANSI_NULLS ON
GO
...
-- Create Date: 03/13/2024
-- Description: sp_GetParetoV3 - Some Notes
CREATE PROCEDURE sp_GetParetoV3(

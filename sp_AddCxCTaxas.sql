...
-- Description: Add the relationship of the CXC and its taxes
-- STORED PROCEDURE NAME:	sp_AddCxCTaxas
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
-- ===================================================================================================================================
...
-- Create Date: 09/01/2022
-- Description: sp_AddCxCTaxas - Add the relationship of the CXC and its taxes
CREATE PROCEDURE sp_AddCxCTaxas(
...
BEGIN
    ...
    SET NOCOUNT ON
    DECLARE @tranName NVARCHAR(50)='sp_AddCxCTaxas';
    BEGIN TRY
        BEGIN TRANSACTION @tranName;
        INSERT INTO CxCTaxas (
            uuidInvoce,
            baseAmount,
            ivaPercentage,
            ivaAmount,
    ...
    BEGIN CATCH
        ...
        DECLARE @infoSended NVARCHAR(MAX)= 'Informacion que se trato de enviar en orden para el SP sp_AddCxCTaxas,
        @uuidInvoice,
        @baseAmount,
        @ivaPercentage,
        @ivaAmount,

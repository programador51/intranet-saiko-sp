...
-- Description: Get the authorization status
-- STORED PROCEDURE NAME:	sp_GetAutorizationsStatus
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
...
-- @isValidTc
-- @isValidPartialities
-- @requireCurrencyExchange
-- @invoiceNumber
-- @invoiceCurrency
-- @ocCurrency
-- @invoiceChangedCurrency
-- @invoiceTotal
-- @ocTotal
-- @partialitiesRequested
-- @newTotalxDocumentTc
-- @newTotalxInstitucionalTc
-- @newTotalxRequestedTc
-- @newTotalxOc
-- ===================================================================================================================================
-- Returns: 
...
-- =================================================================================================
--	2022-07-04		Adrian Alardin   			1.0.0.0			Initial Revision	
-- *****************************************************************************************************************************
SET ANSI_NULLS ON
GO
...
-- Create Date: 07/04/2022
-- Description: sp_GetAutorizationsStatus - Get the authorization status
CREATE PROCEDURE sp_GetAutorizationsStatus(
    @idInvoice INT
) AS 
BEGIN
    ...
    BEGIN
        SELECT @message= @mesasge + 
        '<p> <b>Solicitud de cambio de moneda</b></p>'+ 
        '<p> Solicitud de autorización para cambiar moneda del pedido <b>'+ CONCAT(@invoiceNumber, '</b> de <b>',@invoiceCurrency,'</b> a <b>',@invoiceChangedCurrency,'</b>')
    END
    ...
    '<p> El tipo de cambio al </p>'+ CONCAT('<b>',dbo.FormatDate(dbo.fn_MexicoLocalTime(GETUTCDATE())),'</b>', ' es:') +
    CONCAT(
        '<ul>',

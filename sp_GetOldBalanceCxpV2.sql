...
-- Description: 
-- STORED PROCEDURE NAME:	sp_GetOldBalanceCxpV2
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
...
-- =================================================================================================
--	2024-02-29		Adrian Alardin   			1.0.0.0			Initial Revision	
-- *****************************************************************************************************************************
IF EXISTS (SELECT * FROM sys.objects WHERE type = 'P' AND name ='sp_GetOldBalanceCxpV2')
    BEGIN 

        DROP PROCEDURE sp_GetOldBalanceCxpV2;
    END
GO
SET ANSI_NULLS ON
GO
...
-- Create Date: 02/29/2024
-- Description: sp_GetOldBalanceCxpV2 - Some Notes
CREATE PROCEDURE sp_GetOldBalanceCxpV2(

...
-- Create date: 0-26-2022
-- Description: Get the odc documents
-- STORED PROCEDURE NAME:	sp_GetODCDocuments
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
...
-- =================================================================================================
--	2022-0-26		Adrian Alardin   			1.0.0.0			Initial Revision	
-- *****************************************************************************************************************************
SET ANSI_NULLS ON
GO
...
-- Create Date: 0/26/2022
-- Description: sp_GetODCDocuments - Get the odc documents
CREATE PROCEDURE sp_GetODCDocuments(
    @customerId INT,
    @statusId INT,
    @beginDate DATETIME,
    @endDate DATETIME,
...
--? ----------------- ↓↓↓ Prepare WHERE ↓↓↓ -----------------------
    ...
    SET @WHERE_CLAUSE='WHERE documents.idTypeDocument=3 AND documents.documentNumber IS NOT NULL  ' + @FILTER_CLAUSE

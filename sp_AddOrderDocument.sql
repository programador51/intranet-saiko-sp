...
-- Description: Add a order type document and if necessary, create the period record
-- STORED PROCEDURE NAME:	sp_AddOrderDocument
-- **************************************************************************************************************************************************
-- =============================================
-- PARAMETERS:
...
-- Create Date: 04/20/2022
-- Description: sp_AddOrderDocument - Add a order type document and if necessary, create the period record
CREATE PROCEDURE sp_AddOrderDocument(
    @idContact INT,
    @idTypeDocument INT,
    @idCurrency INT,
    @tc DECIMAL (14,2),

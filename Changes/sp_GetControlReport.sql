...
SELECT 
        ...
        clientInvoice.total - clientInvoice.residue AS [client.charged.total],
        ...
        odc.totalAmount AS [supplier.odc.total],
        odcStatus.description AS [supplier.odc.status],
        odcCurrency.code AS [supplier.odc.currency],
        ...
        supplierInvoice.createdDate AS [supplier.invoice.date],
        supplierInvoice.total/odc.totalAmount AS [supplier.invoice.tc],
